...
function ProjectCard({ project, index }) {
   ...
   const glowHover   = project.isPurple
      ...
      : "hover:shadow-[0_0_60px_rgba(0,232,122,0.10)]"
            ...
            <div className="flex-1 flex flex-col gap-6">
               ...
               <div className="flex flex-col gap-3">
                  <div className="flex items-center gap-2.5">
                     <span className="relative flex h-2 w-2">
                        <span className={`animate-ping absolute inline-flex h-full w-full rounded-full ${pingColor} opacity-60`}></span>
               ...
               <div className="flex flex-wrap gap-2">
                  {project.stack.map((tech) => (
                     <span
                        key={tech}
                        className="px-3 py-1 rounded-full border border-purple-dim/30 bg-bg-elevated text-text-muted text-xs font-medium"
                     >
                        {tech}
                     </span>
                  ))}
