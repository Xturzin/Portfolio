   ...
   return (
      <SectionWrapper id="sobre" variant="fadeLeft" className="py-32 px-6 md:px-12 max-w-6xl mx-auto">
         ...
         <div className="flex flex-col md:flex-row gap-12 md:gap-16 items-start">
            ...
            >
               <div className="rounded-2xl border border-purple-dim/30 bg-bg-surface p-6 flex flex-col gap-5">
            ...
            <div className="flex-1 flex flex-col gap-8">
               ...
               <div className="flex flex-col gap-4 text-text-secondary text-base leading-relaxed">
                  <p>
                     Sou um desenvolvedor full stack com cerca de 5 anos de experiencia pratica construindo aplicacoes web reais. Trabalho de forma independente, do planejamento ao deploy, cobrindo tanto o front quanto o back end com atencao igual a cada camada.
                  </p>
                  <p>
                     Meu foco e criar produtos que funcionam bem, sao faceis de usar e sustentaveis a longo prazo. Gosto de entender o problema antes de abrir o editor, e de manter o codigo tao limpo quanto a interface que ele sustenta.
                  </p>
               </div>
